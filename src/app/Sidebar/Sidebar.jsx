...
function sidebar() {
  return (
    ...
    <div className="right-side-bottom">
        <div className="raund-buttom login">  <NavLink className="nav-link" to="/Login">Login</NavLink></div>
        <div className="raund-buttom register"><NavLink className="nav-link" to="/Register">Register</NavLink></div>
    </div>
